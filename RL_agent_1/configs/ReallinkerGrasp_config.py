...
class RobotCfg:
    ...
    def __init__(self,global_cfg):
        ...
        self.urdf_files_dict = {
            ...
            "reallinker": "urdf/reallinker/urdf/Embodied lifting robot_two wheels_RM75-B-V.urdf",
            "oreo": "urdf/oreo.urdf",
...
class TaskCfg:
    ...
    def __init__(self,global_cfg):
        ...
        self.reward_scales = {
            ...
            "obj_reset": self.c9,
            "right_hand_collision_reset": self.c7,
        }
