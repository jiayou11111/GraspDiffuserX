...
class RotationTransformer:
    """Dummy transformer that does nothing, for axis_angle only"""
    def __init__(self, from_rep='axis_angle', to_rep='axis_angle', from_convention=None, to_convention=None):
        # 不做任何转换
        pass
